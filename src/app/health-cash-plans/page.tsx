...
export const metadata: Metadata = {
  ...
  description:
    'Using Health Shield, Simplyhealth, Medicash or similar health cash plans for treatments at Sanctum Wellbeing in Cardiff—check your cover and how to claim.',
};
...
export default function HealthCashPlansPage() {
  return (
    <>
      <main
        id="top"
      ...
      >
        ...
        <Banner
          ...
          subtitle="Health Shield, Simplyhealth, Medicash and similar plans"
          imgUrl={lady}
          titleAside={
            <Link
              href="/"
          ...
          content={[
            'Do you have a Health Shield, Simplyhealth, Medicash, or similar health cash plan?',
            'Depending on your policy and level of cover, you may be able to claim back the cost of eligible treatments.',
          ]}
        />
        ...
        >
          ...
          <div className="relative z-[1] space-y-2">
            <FancySection>
              <SectionTitle>Check your cover first</SectionTitle>
              <p>
                Policies vary widely. Always check your policy documents or contact your provider
                to confirm whether complementary therapies (such as massage or reflexology) are
                included, and what evidence or receipts they need.
              </p>
            </FancySection>

            <FancySection>
              <SectionTitle>What you might be able to claim</SectionTitle>
              <p>
                Depending on your policy and level of cover, you could be reimbursed the cost of
                treatments—subject to your plan&apos;s rules, limits, and any excess.
              </p>
              <GradientBulletList
                items={[
                  'Health Shield, Simplyhealth, Medicash, and other cash plan providers',
                  'Cover for therapies varies by plan—confirm before you book',
                  'Keep invoices or receipts if your insurer asks for them',
                ]}
              />
            </FancySection>
            ...
            <FancySection>
              ...
              <p>
                If you&apos;re unsure how your plan works or what to ask your insurer, please
                contact me and I&apos;ll do my best to point you in the right direction.
              </p>
            </FancySection>
            ...
            <div className="mt-2 rounded-2xl bg-gradient-to-b from-white to-[#faf8ff]/90 px-4 py-9 sm:px-10 sm:py-11 text-center shadow-[0_8px_32px_-8px_rgba(144,137,252,0.45)]">
                ...
                <p className="font-sans text-lg sm:text-base leading-7 text-gray-600 mb-9 max-w-xl mx-auto">
                  Email me if you need further information about treatments at Sanctum Wellbeing.
                </p>
